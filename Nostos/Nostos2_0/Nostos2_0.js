...
function newDrop(event) {
    ...
    function checkCompletion(lastWord) {
        ...
        if (sorrowDropped && happyDropped) {
            // Check if the last word is 'sorrow' and navigate to 'happy.html'
            if (lastWord === 'sorrow') {
                window.location.href = 'fragmentShader_Sound/sorrow.html';
            }

            // Check if the last word is 'happy' and navigate to 'fragmentshader.html'
            if (lastWord === 'happy') {
